                ...
                <div class="video-side">
                    <div class="image">
                        <div class="plyr__video-embed" id="player">
                            ...
                            <video id="video-episode" data-episode-id="<?php echo $episode["episode_id"]; ?>"
                                   src="/resources/episodes/<?php echo $episode["episode_url"]; ?>" <?php echo $userSettings["setting_video_autoplay"] ? "autoplay" : "" ?>
                                   controls controlsList="nodownload" about="Episode Video"></video>
                            ...
                            <div class="quick-actions">
                                <a class="quick-action">
                                    <i data-episode-owner="<?php echo $lecturer["user_id"]; ?>"
                                       data-item-id="<?php echo $episode["episode_id"]; ?>" class="like-episode"
                                       data-feather="thumbs-up"></i>
                                </a>
                                <a class="quick-action">
                                    <i data-episode-owner="<?php echo $lecturer["user_id"]; ?>"
                                       data-item-id="<?php echo $episode["episode_id"]; ?>" class="dislike-episode"
...
<!--                                </a>-->
                                <a class="quick-action">
                                    <i data-episode-owner="<?php echo $lecturer["user_id"]; ?>"
                                       data-item-id="<?php echo $episode["episode_id"]; ?>" class="watch-later"
                                       data-feather="watch"></i>
                                </a>
                                <a class="quick-action">
                                    <i data-episode-owner="<?php echo $lecturer["user_id"]; ?>"
                                       data-item-id="<?php echo $episode["episode_id"]; ?>" data-feather="cast"></i>
                                </a>
                        ...
                        <div class="video-owner">
                            ...
                            <a data-episode-owner="<?php echo $lecturer["user_id"]; ?>"
                               data-item-id="<?php echo $episode["episode_id"]; ?>" class="button favorite-episode">
                                Favorites :
                                ...
                                <form id="comment-form" method="post">
                                    <div class="control">
                                        <textarea id="comment-content"
                                                  data-episode-id="<?php echo $episode["episode_id"]; ?>"
                                                  form="comment-form" name="comment" class="textarea"
                                                  placeholder="Add a comment..." rows="4" required></textarea>
                            ...
                            <div class="media is-comment">
                                <div class="media-left">
                                    <div class="avatar-wrap is-smaller">
                                        <img src="https://via.placeholder.com/150x150"
                                             data-demo-src="/images/profile-images/<?php echo $commentor["user_image"]; ?>"
                                            ...
                                            foreach ($allReplyComments as $replyComment) {
                                                ...
                                                <div class="media is-comment is-nested">
                                                    <figure class="media-left">
                                                        <div class="avatar-wrap is-smaller">
                                                            <img src="https://via.placeholder.com/150x150"
                                                                 data-demo-src="/images/images/profile-images/<?php echo $replier["commentor_id"]; ?>"
                        ...
                        <div class="autoplay">
                            ...
                            <div class="autoplay-toggle">
                                ...
                                <label class="f-switch is-primary">
                                    <input id="setting-allow-autoplay"
                                           data-setting-value="<?php echo $userSettings["setting_video_autoplay"]; ?>"
                                           type="checkbox"
                                           class="is-switch" <?php echo $userSettings["setting_video_autoplay"] ? "checked" : "" ?>>
                                    <i></i>
                                </label>
                        ...
                        <div class="media related-card">
                            <div class="media-left">
                                <a href="<?php echo $currentNext["episode_id"]; ?>" class="image">
                                    <img src="https://via.placeholder.com/120x90"
                                         data-demo-src="/images/covers/<?php echo $currentNext["episode_small_art_cover"]; ?>"
                                         alt="">
                                </a>
                            </div>
                            ...
                            <div class="media-content">
                                <div class="video-meta">
                                    <a href="<?php echo $currentNext["episode_id"]; ?>"
                                       class="related-title"><?php echo $currentNext["episode_name"]; ?></a>
                                    <div class="submeta">
                                        <img src="https://via.placeholder.com/150x150"
                                             data-demo-src="/images/profile-images/<?php echo $lecturer["user_image"]; ?>"
                                             data-page-popover="2"
                            ...
                            <div class="media related-card">
                                <div class="media-left">
                                    <a href="<?php echo $sidebarEpisode["episode_id"]; ?>" class="image">
                                        <img src="https://via.placeholder.com/120x90"
                                             data-demo-src="/images/covers/<?php echo $sidebarEpisode["episode_small_art_cover"]; ?>"
                                             alt="">
                                    </a>
                                </div>
                                <div class="media-content">
                                    <div class="video-meta">
                                        <a href="<?php echo $sidebarEpisode["episode_id"]; ?>"
                                           class="related-title"><?php echo $sidebarEpisode["episode_name"]; ?></a>
                                        <div class="submeta">
                                            <img src="https://via.placeholder.com/150x150"
                                                 data-demo-src="/images/profile-images/<?php echo $lecturer["user_image"]; ?>"
                                                 data-page-popover="2"
