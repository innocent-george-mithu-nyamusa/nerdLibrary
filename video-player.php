...
$allEpisodeRootComments = $commentObj->getAllItemRootComments($_GET["eId"]);
$numberOfRootComments = $commentObj->getNumberOfComments($_GET["eId"]);
$userSettings = $settingsObj->getUserSettings($_SESSION["user_id"]);

if (!$allEpisodeRootComments) {

    $allEpisodeRootComments = [];
}

$episode = $episodeObj->getEpisode($_GET["eId"]);
$nextEpisodes = $episodeObj->allChapterEpisodes($episode["episode_chapter_id"]);

//    TODO:: CREATE RESOURCE FOR STATS
if (Utilities::isLoggedIn()) {

    if ($statsObj->hasUserReacted($_SESSION["user_id"], $episode["episode_id"])) {
        $statsObj->updateView($episode["episode_id"], $_SESSION["user_id"]);
    } else {
        $statsObj->createResource($episode["episode_id"], $_SESSION["user_id"]);
        $statsObj->updateView($episode["episode_id"], $_SESSION["user_id"]);
    }

    $activityObj->createActivity("Viewed {$episode["episode_name"]}", "view", $episode["episode_id"], $_SESSION["user_id"]);
} else {

    //HIGHLIGHT:: USING ANONYMOUS USER DETAILS
    if ($statsObj->hasUserReacted('edf502709f3bc863c7a30933909e79fd', $episode["episode_id"])) {
        $statsObj->updateView($episode["episode_id"], 'edf502709f3bc863c7a30933909e79fd');
    } else {
        $statsObj->createResource($episode["episode_id"], 'edf502709f3bc863c7a30933909e79fd');
        $statsObj->updateView($episode["episode_id"], 'edf502709f3bc863c7a30933909e79fd');
    }
}

$friends = $statsObj->getViews($episode["episode_id"]);
$allFavorites = $statsObj->getFavorites($episode["episode_id"]);
$series = $series = $seriesObj->getSeries($episode["episode_series_id"]);
...
//We need today's date to calculate when the video was uploaded
$dateToday = new DateTime('now');
$todayDate = $dateToday->format("Y-m-d h:i:sa");

$premierDate = new DateTime($episode["episode_premiered_date"]);
$dateDiff = date_diff($dateToday, $premierDate);
...
<body>
    ...
    <div class="sidebar-v1 is-fold">
        <div class="top-section">
            ...
            <div class="user-block">
                <img class="avatar" src="https://via.placeholder.com/150x150" data-demo-src="/images/profile-images/<?php echo $_SESSION['image']; ?>" alt="">
                <div class="meta">
    ...
    <div class="view-wrapper is-sidebar-v1 is-fold">
                        ...
                        <div class="nav-drop is-account-dropdown">
                            <div class="inner">
                                ...
                                <div class="nav-drop-body account-items">
                                    <a id="profile-link" href="profile-main.html" class="account-item">
                                        <div class="media">
                                            <div class="media-left">
                                                <div class="image">
                                                    <img src="https://via.placeholder.com/400x400" data-demo-src="/images/profile-images/<?php echo $_SESSION['image']; ?>" alt="Account User Image">
                                                </div>
                                            </div>
                                            <div class="media-content">
                                    ...
                                    <a href="/helpdesk" class="account-item">
                                        <div class="media">
                                            <div class="icon-wrap">
                                    ...
                                    <a href="/nerdLbrary/logout_account" class="account-item">
                                        <div class="media">
                                            <div class="icon-wrap">
        ...
        <!-- Container -->
        <div id="video-feed" class="container sidebar-boxed" data-open-sidebar data-page-title="<?php
                                                                                                echo $episode["episode_name"];
                                                                                                ?>">
            <div class="videos-wrapper has-player is-full">
                ...
                <div class=" player-wrapper">
                    <div class="video-side">
                        <div class="image">
                            <div class="plyr__video-embed" id="player">
                                <!--                            <iframe src="https://www.youtube.com/embed/J0PtGdp-Cgs?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1"-->
                                <!--                                    allowfullscreen allow="autoplay"></iframe> -->

                                <video id="video-episode" data-episode-id="<?php echo $episode["episode_id"]; ?>" src="/resources/episodes/<?php echo $episode["episode_url"]; ?>" <?php echo $userSettings["setting_video_autoplay"] ? "autoplay" : "" ?> controls controlsList="nodownload" about="Episode Video"></video>

                            </div>
                        </div>
                        <div class="meta-box video-meta">
                            <div class="video-title"><?php echo $episode["episode_name"]; ?></div>
                            <div class="video-subtitle">
                                ...
                                <div class="views-count">
                                    ...
                                    switch (strlen($friends)) {
                                        ...
                                        case 5:
                                        case 4:
                                            echo substr($friends, 0, -3) . "k";
                                            break;
                                        case 8:
                                        case 9:
                                        case 7:
                                            echo substr($friends, 0, -6) . "M";
                                            break;
                                        case 10:
                                        case 11:
                                        case 12:
                                            echo substr($friends, 0, -9) . "B";
                                            break;
                                        case 13:
                                        case 14:
                                        case 15:
                                            echo substr($friends, 0, -12) . "T";
                                            break;
                                        default:
                                            echo $friends;
                                    }
                                ...
                                <div class="quick-actions">
                                    <a class="quick-action">
                                        <i data-episode-owner="<?php echo $lecturer["user_id"]; ?>" data-item-id="<?php echo $episode["episode_id"]; ?>" class="like-episode" data-feather="thumbs-up"></i>
                                    </a>
                                    <a class="quick-action">
                                        <i data-episode-owner="<?php echo $lecturer["user_id"]; ?>" data-item-id="<?php echo $episode["episode_id"]; ?>" class="dislike-episode" data-feather="thumbs-down"></i>
                                    </a>
                                    <!--                                <a class="quick-action">-->
                                    <!--                                    <i data-episode-owner="--><?php //echo $lecturer["user_id"]; 
                                                                                                        ?>
                                    <!--"-->
                                    <!--                                       data-item-id="--><?php //echo $episode["episode_id"]; 
                                                                                                ?>
                                    <!--"-->
                                    <!--                                       data-fancybox=""-->
                                    <!--                                       class="share-episode"-->
                                    ...
                                    <!--                                </a>-->
                                    <a class="quick-action">
                                        <i data-episode-owner="<?php echo $lecturer["user_id"]; ?>" data-item-id="<?php echo $episode["episode_id"]; ?>" class="watch-later" data-feather="watch"></i>
                                    </a>
                                    <a class="quick-action">
                                        <i data-episode-owner="<?php echo $lecturer["user_id"]; ?>" data-item-id="<?php echo $episode["episode_id"]; ?>" data-feather="cast"></i>
                                    </a>
                            ...
                            <div class="video-owner">
                                <img src="https://via.placeholder.com/150x150" data-demo-src="/images/profile-images/<?php echo $lecturer["user_image"]; ?>" alt="">
                                <div class="meta">
                                    <span><?php echo $lecturer["user_fullname"]; ?></span>
                                    <span>
                                        Uploaded
                                        <?php
                                        echo Utilities::elapsedTimeString("{$episode["episode_premiered_date"]}", $endDate);
                                        ?>
                                    </span>
                                </div>
                                <a data-episode-owner="<?php echo $lecturer["user_id"]; ?>" data-item-id="<?php echo $episode["episode_id"]; ?>" class="button favorite-episode">
                                    Favorites :

                                    <?php
                                    $allFavorites = "$allFavorites";

                                    switch (strlen($allFavorites)) {
                                        case 6:
                                        case 5:
                                        case 4:
                                            echo substr($allFavorites, 0, -3) . "k";
                                            break;
                                        case 8:
                                        case 9:
                                        case 7:
                                            echo substr($allFavorites, 0, -6) . "M";
                                            break;
                                        case 10:
                                        case 11:
                                        case 12:
                                            echo substr($allFavorites, 0, -9) . "B";
                                            break;
                                        case 13:
                                        case 14:
                                        case 15:
                                            echo substr($allFavorites, 0, -12) . "T";
                                            break;
                        ...
                        <div class="meta-box video-description">
                            <h4>Description</h4>
                            <?php
                            echo htmlspecialchars_decode($episode["episode_description"]);
                            ?>
                            <hr>
                            <a id="description-show-more" class="has-text-centered video-description-more">Show More</a>
                        </div>
                        <?php
                        ...
                        ?>
                                ...
                                <div class="media comment-box">
                                    <div class="media-left">
                                        <div class="avatar-wrap">
                                            <img src="https://via.placeholder.com/150x150" data-demo-src="/images/profile-images/<?php echo $_SESSION["image"]; ?>" data-user-popover="0" alt="">
                                            <div class="badge">
                                                <i data-feather="check"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="media-content">
                                        <form id="comment-form" method="post">
                                            <div class="control">
                                                <textarea id="comment-content" data-episode-id="<?php echo $episode["episode_id"]; ?>" form="comment-form" name="comment" class="textarea" placeholder="Add a comment..." rows="4" required></textarea>
                                                <button id="add-comment-btn" type="submit" form="comment-form" class="button">
                                                    Post Comment
                                                </button>
                                            </div>
                                        </form>
                            ...
                            <?php } ?>
                            <div id="comment-parent" class="comments-count">
                                <h3>
                                    Comments (<?php echo isset($numberOfRootComments) ? $numberOfRootComments : 0; ?>)
                                </h3>
                            </div>
                            ...
                            foreach ($allEpisodeRootComments as $allEpisodeRootComment) {

                                $commentor = $userObj->getUser($allEpisodeRootComment["commentor_id"])[0];
                                $numberOfReplies = $commentObj->getNumberOfComments($allEpisodeRootComment["comment_id"], false);
                                $allReplyComments = $commentObj->getAllReplyComments($allEpisodeRootComment["comment_id"]);
                                //
                                //                        
                            ?>
                                <div class="media is-comment">
                                    <div class="media-left">
                                        <div class="avatar-wrap is-smaller">
                                            <img src="https://via.placeholder.com/150x150" data-demo-src="/images/profile-images/<?php echo $commentor["user_image"]; ?>" data-user-popover="1" alt="">
                                            <div class="badge">
                                                <i data-feather="check"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="media-content">
                                        <div class="comment-meta">
                                            ...
                                            <h4><a><?php
                                                    echo $commentor["user_fullname"]; ?></a> <small>
                                                    · <?php echo Utilities::elapsedTimeString($allEpisodeRootComment["comment_date"], $endDate); ?></small>
                                            </h4>
                                            <p>
                                                <?php
                                                //Show the Comment
                                                echo $allEpisodeRootComment["comment"];
                                                ?>
                                        ...
                                        <div class="comment-stats-wrap">
                                            <div class="comment-stats">
                                                <div class="stat is-likes">
                                                    ...
                                                    <span>
                                                        <?php
                                                        echo $statsObj->getItemLikes($allEpisodeRootComment["comment_id"]);
                                                        ?>
                                                    </span>
                                                </div>
                                                <div class="stat is-dislikes">
                                                    ...
                                                    <span>
                                                        <?php
                                                        echo $statsObj->getItemDisLikes($allEpisodeRootComment["comment_id"]);
                                                        ?>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="nested-replies">
                                            <a class="header">
                                                <span><?php echo isset($numberOfReplies) ? $numberOfReplies : 0; ?> Replies</span>
                                                <i data-feather="chevron-down"></i>
                                            </a>
                                            <div id="comment-parent" class="nested-comments">

                                                <?php

                                                //Display all reply comments

                                                foreach ($allReplyComments as $replyComment) {
                                                    $replier = $userObj->getUser($replyComment["commentor_id"]);
                                                ...
                                                ?>
                                                    ...
                                                    <div class="media is-comment is-nested">
                                                        <figure class="media-left">
                                                            <div class="avatar-wrap is-smaller">
                                                                <img src="https://via.placeholder.com/150x150" data-demo-src="/images/images/profile-images/<?php echo $replier["commentor_id"]; ?>" data-user-popover="11" alt="">
                                                                <!--                                                 TODO:: FIX POPOVER VALUE-->
                                                            </div>
                                                        </figure>
                                                        <div class="media-content">
                                                            <div class="comment-meta">
                                                                <h4><a><?php echo $replier["user_fullname"]; ?></a> <small>
                                                                        · 30 minutes ago</small></h4>
                                                                <p>
                                                                    <span class="mention">@Dan Walker</span>
                                                                    <?php
                                                                    echo $replyComment["comment"];
                                                                    ?>.
                                                                </p>
                                                            </div>
                                                            <div class="comment-stats-wrap">
                                                                <div class="comment-stats">
                                                                    <div class="stat is-likes">
                                                                        ...
                                                                        <span>
                                                                            <?php
                                                                            echo $statsObj->getFavorites($allEpisodeRootComment["comment_id"]);
                                                                            ?>
                                                                        </span>
                                                                    </div>
                                                                    <div class="stat is-dislikes">
                            ...
                            <!--                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis porta eros lacus,-->
                            <!--                                        nec-->
                            ...
                            <!--                                <div class="avatar-wrap is-smaller">-->
                            <!--                                    <img src="https://via.placeholder.com/150x150"-->
                            <!--                                         data-demo-src="assets/img/avatars/placeholder-m.jpg" alt="">-->
                            <!--                                </div>-->
                            <!--                            </figure>-->
                            <!--                            <div class="media-content">-->
                            <!--                                <div class="comment-meta">-->
                    ...
                    <div class="related-side">
                        <div class="meta-box related-list">
                            <?php
                            $currentNext = $episodeObj->getNextEpisode($episode["episode_chapter_id"], $episode["episode_number_in_chapter"]);
                            ...
                            ?>
                                ...
                                <div class="autoplay">
                                    ...
                                    <div class="autoplay-toggle">
                                        ...
                                        <label class="f-switch is-primary">
                                            <input id="setting-allow-autoplay" data-setting-value="<?php echo $userSettings["setting_video_autoplay"]; ?>" type="checkbox" class="is-switch" <?php echo $userSettings["setting_video_autoplay"] ? "checked" : "" ?>>
                                            <i></i>
                                        </label>
                                ...
                                <div class="media related-card">
                                    <div class="media-left">
                                        <a href="<?php echo $currentNext["episode_id"]; ?>" class="image">
                                            <img src="https://via.placeholder.com/120x90" data-demo-src="/images/covers/<?php echo $currentNext["episode_small_art_cover"]; ?>" alt="">
                                        </a>
                                    </div>

                                    <div class="media-content">
                                        <div class="video-meta">
                                            <a href="<?php echo $currentNext["episode_id"]; ?>" class="related-title"><?php echo $currentNext["episode_name"]; ?></a>
                                            <div class="submeta">
                                                <img src="https://via.placeholder.com/150x150" data-demo-src="/images/profile-images/<?php echo $lecturer["user_image"]; ?>" data-page-popover="2" alt="">
                                                <div class="info">
                                                    <span class="video-account"><?php echo $lecturer["username"]; ?></span>
                                ...
                                <div class="related-label">
                                    <h4 class="related-title">Coming Up</h4>
                                </div>
                                <!-- Related Video -->

                                <?php

                                $sidebarEpisodes = $episodeObj->allOtherChapterEpisodes($episode["episode_chapter_id"], $currentNext["episode_id"], $episode["episode_id"]);

                                if (!$sidebarEpisodes) {
                                    $sidebarEpisodes = [];
                                }

                                foreach ($sidebarEpisodes as $sidebarEpisode) {

                                ?>
                                    <!--                        TODO::GET RELATED VIDEOS-->
                                    <div class="media related-card">
                                        <div class="media-left">
                                            <a href="<?php echo $sidebarEpisode["episode_id"]; ?>" class="image">
                                                <img src="https://via.placeholder.com/120x90" data-demo-src="/images/covers/<?php echo $sidebarEpisode["episode_small_art_cover"]; ?>" alt="">
                                            </a>
                                        </div>
                                        <div class="media-content">
                                            <div class="video-meta">
                                                <a href="<?php echo $sidebarEpisode["episode_id"]; ?>" class="related-title"><?php echo $sidebarEpisode["episode_name"]; ?></a>
                                                <div class="submeta">
                                                    <img src="https://via.placeholder.com/150x150" data-demo-src="/images/profile-images/<?php echo $lecturer["user_image"]; ?>" data-page-popover="2" alt="">
                                                    <div class="info">
                                                        <span class="video-account"><?php echo $lecturer["username"]; ?></span>
                                ...
                                <!--                                         data-demo-src="assets/img/demo/video/home/collections/c19.jpg" alt="">-->
                                <!--                                </a>-->
                                <!--                            </div>-->
                                <!--                            <div class="media-content">-->
                                <!--                                <div class="video-meta">-->
