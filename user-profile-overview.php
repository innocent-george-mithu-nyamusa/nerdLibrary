                                        ...
                                        <div class="column">
                                            ...
                                            ?>
                                                ...
                                                <div class="flex-block">
                                                    <img src="https://via.placeholder.com/400x400" data-demo-src="/images/series/<?php echo $series["series_image"]; ?>" alt="" data-page-popover="4">
                                                    <div class="flex-block-meta">
                                                        <span><?php echo $categorySeries["category_name"]; ?> <a><?php echo $series["series_name"]; ?></a></span>
                                                        <a href="/course-track/<?php echo $series["series_id"]; ?>" class="action-link"><?php echo $_SESSION["role"] == "user" ? "You enrolled in this Course" : "You created this course"; ?></a>
                                                    </div>
                                    ...
                                    ?>
                                        ...
                                        <div class="timeline-item">
                                            <div class="image-container">
                                                <img src="https://via.placeholder.com/800x600" alt="" data-demo-src="/images/covers/<?php echo $edSeries["series_small_square_image"]; ?>">
                                                <div class="logo-container">
                                                    <img src="https://via.placeholder.com/150x150" alt="" data-demo-src="/images/profile-images/<?php echo $seriesOwner[0]["user_image"]; ?>" data-page-popover="6">
                                                </div>
                                            </div>
                            ...
                            <div id="job-content" class="content-section">
                                ...
                                <div id="jobs-glider" class="slider-timeline about-glider">
                                    ...
                                    ?>
                                        ...
                                        <div class="timeline-item">
                                            <div class="image-container">
                                                <img src="https://via.placeholder.com/800x600" alt="" data-demo-src="/images/covers/<?php echo $videoEpisode["episode_small_art_cover"]; ?>">
                                                <div class="logo-container">
                                                    <img src="https://via.placeholder.com/150x150" alt="" data-demo-src="/images/profile-images/<?php echo $episodeLecturer["user_image"]; ?>" data-page-popover="<?php echo $episodeLecturer["user_no"]; ?>">
                                                </div>
                                            </div>
                                            ...
                                            ?>
                                                ...
                                                <div class="column is-6">
                                                    <div class="friend-small-card">
                                                        <img src="https://via.placeholder.com/150x150" data-demo-src="/images/profile-images/<?php echo $friendUser[0]["user_image"]; ?>" data-user-popover="<?php echo $friendUser[0]["user_no"] ?>" alt="">
                                                        <div class="meta">
                                        ...
                                        <div class="photo-list">
                                            ...
                                            <?php foreach ($allMyPhotos as $photo) { ?>
                                                ...
                                                <div class="photo-wrapper">
                                                    ...
                                                    <img src="https://via.placeholder.com/400x400" data-demo-src="/images/media/posts/<?php echo $photo["photo_name"]; ?>" alt="Photo ">
                                                </div>
                                            <?php } ?>
            ...
            <div id="chat-body" class="chat-body is-opened">
                ...
                <div id="dan-conversation" class="chat-body-inner has-slimscroll">
                    ...
                    <div class="chat-message is-sent">
                        <img src="https://via.placeholder.com/300x300" data-demo-src="images/profile-images/student.jpeg" alt="">
                        <div class="message-block">
                            <span>8:12am</span>
