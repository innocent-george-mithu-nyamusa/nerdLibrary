                                    ...
                                    <div class="content-wrap">
                                        ...
                                        <div class="card-heading">
                                            ...
                                            <div class="user-block">
                                                <div class="image">
                                                    <img src="https://via.placeholder.com/300x300" data-demo-src="/images/pages/<?php echo $postOwner["page_icon"]; ?>" data-user-popover="<?php echo $postOwner["page_no"]; ?>" alt="">
                                                </div>
                                                <div class="user-info">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php if (isset($feedPost["post_shared_link"]) && ($feedPost["post_type"] == "photo")) { ?>
                                                ...
                                                <div class="post-image">
                                                    ...
                                                    <div class="like-wrapper">
                                                        <a href="javascript:void(0);" data-item-id="<?php echo $feedPost["post_images"]; ?>" class="like-button">
                                            ...
                                            ?>
                                                <div class="post-actions">
                                                    ...
                                                    <div class="like-wrapper">
                                                        <a href="javascript:void(0);" data-item-id="<?php echo $feedPost["post_id"]; ?>" class="like-button">
                                                            <i class="mdi mdi-heart not-liked bouncy"></i>
                                                            <i class="mdi mdi-heart is-liked bouncy"></i>
                                                            <span class="like-overlay"></span>
                                                        </a>
        ...
        <div id="upload-crop-profile-modal" class="modal upload-crop-profile-modal is-xsmall has-light-bg">
            ...
            <div class="modal-content">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button id="submit-profile-picture" class="button is-solid accent-button is-fullwidth raised is-disabled">Use Picture
                        </button>
                    </div>
                </div>
