                ...
                <div class="videos-sidebar-inner">
                    <div class="user-block">
                        ...
                        <div class="avatar-wrap">
                            <img src="https://via.placeholder.com/150x150" data-demo-src="/images/profile-images/<?php echo $lecturer['user_image']; ?>" data-user-popover="0" alt="">
                            <div class="badge">
                ...
                <div class="video-header-wrap">
                    ...
                    <div class="video-header-outer">
                        <div class="video-header">
                            <!-- Image -->
                            <img class="cover" src="https://via.placeholder.com/1920x1080" data-demo-src="/images/covers/<?php echo $seriesCoverImages[0]; ?>" alt="">
                            <!-- Overlay -->
                                        ...
                                        <div class="caption-block">
                                            ...
                                            ?>
                                                    <div class="caption-actions">
                                                        <a href="/watch/<?php echo $firstEpisodeId; ?>" id="start-watching-btn-1" class="button is-solid accent-button is-rounded">
                                                            Start Watching
                                                        </a>
                                                ...
                                                <?php } else { ?>
                                                    <div class="caption-actions">
                                                        <a value="<?php echo $series["series_id"]; ?>" cust-first-lecture="<?php echo isset($firstEpisodeId) ? $firstEpisodeId : 0; ?>" id="enrollment-btn" class="button is-solid accent-button is-rounded">
                                                            Start On Track
                                                        </a>
                                                        <a data-fancybox="" data-src="/resources/episodes/<?php echo $introVideo; ?>" class="trailer-button">
                                                            <i data-feather="play"></i>
                                                ...
                                                <div class="caption-actions">
                                                    <a data-success-url="<?php echo $utility->userPaymentLink($series["series_account"]); ?>" data-subscription="<?php echo $series["series_account"]; ?>" data-subscriber-id="<?php echo $_SESSION["user_id"]; ?>" class="button is-solid accent-button is-rounded add-subscription">
                                                        Pay Subscription
                                                    </a>
                                                    <a data-fancybox id="morphing" data-src="#morphing-content" class="trailer-button">
                    ...
                    <div class="video-header-outer">
                        <div class="video-header">
                            <!-- Image -->
                            <img class="cover" src="https://via.placeholder.com/1920x1080" data-demo-src="/images/covers/<?php echo $seriesCoverImages[1]; ?>" alt="">
                            <!-- Overlay -->
                            <div class="cover-overlay"></div>
                            <!-- Caption -->
                            <div class="cover-caption">
                    ...
                    <div class="video-header-outer">
                        <div class="video-header">
                            <!-- Image -->
                            <img class="cover" src="https://via.placeholder.com/1920x1080" data-demo-src="/images/covers/<?php echo $seriesCoverImages[2]; ?>" alt="">
                            <!-- Overlay -->
                            <div class="cover-overlay"></div>
                            <!-- Caption -->
                            <div class="cover-caption">
