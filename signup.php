        ...
        <div class="outer-panel-inner">
                    ...
                    <div class="column is-4">
                        <div class="account-type">
                            <div class="type-image">
                                ...
                                <img class="type-bg light-image" src="assets/img/illustrations/signup/type-1-bg.svg"
                                     alt="">
                                <img class="type-bg dark-image" src="assets/img/illustrations/signup/type-1-bg-dark.svg"
                                     alt="">
                            </div>
                            <h3>Organization</h3>
                    ...
                    <div class="column is-4">
                        <div class="account-type">
                            <div class="type-image">
                                ...
                                <img class="type-bg light-image" src="assets/img/illustrations/signup/type-2-bg.svg"
                                     alt="">
                                <img class="type-bg dark-image" src="assets/img/illustrations/signup/type-2-bg-dark.svg"
                                     alt="">
                            </div>
                    ...
                    <div class="column is-4">
                        <div class="account-type">
                            <div class="type-image">
                                ...
                                <img class="type-bg light-image" src="assets/img/illustrations/signup/type-3-bg.svg"
                                     alt="">
                                <img class="type-bg dark-image" src="assets/img/illustrations/signup/type-3-bg-dark.svg"
                                     alt="">
                            </div>
                            <h3> Student </h3>
            ...
            <div id="signup-panel-2" class="process-panel-wrap is-narrow">
                <form action="" id="loginForm" method="post">
                    ...
                    <div class="form-panel">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" class="input" id="user_firstname" name="user_firstname"
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" class="input" id="user_lastname" name="user_lastname"
                        ...
                        <div class="field">
                            <label>Email</label>
                            <div class="control">
                                <input type="text" class="input" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" id="user_email"
                                       name="user_email"
                ...
                <div class="buttons">
                    ...
                    <button type="submit" form="loginForm" class="button process-button is-next-2"
                            data-step="step-dot-3">Next
                    </button>
                </div>
            </div>
                ...
                <div class="form-panel">
                    <div class="photo-upload">
                        <div class="preview">
                            ...
                            <form id="profile-pic-dz" class="dropzone is-hidden"
                                  action="http://localhost/images"></form>
                        </div>
            ...
            <div id="signup-panel-4" class="process-panel-wrap is-narrow">
                <form id="loginFormPassword" method="post" action="">
                    <div class="form-panel">
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="password" min="8" id="user_password" name="user_password" class="input"
                                       placeholder="Must have 8 characters, Uppercase and lowercase letters" required>
                            </div>
                        </div>
                        <div class="field">
                            <label>Repeat Password</label>
                            <div class="control">
                                <input type="password" min="8" id="password_confirm" name="password_confirm"
                                       class="input" placeholder="Repeat your password " required>
                            </div>
                        </div>
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" class="input" id="user_phone" name="user_phone"
                                       placeholder="Enter your phone number e.g +263 XXX XXX XXX" required>
                            </div>
                        </div>
                    </div>
                    <div id='mail_success' class='success'>Your have registered successfully.</div>
                ...
                <div class="buttons">
                    ...
                    <button type="submit" form="loginFormPassword" class="button process-button is-next-4"
                            data-step="step-dot-5">Next
                    </button>
                </div>
            </div>
