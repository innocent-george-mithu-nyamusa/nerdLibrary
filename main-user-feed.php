                            ...
                            <div class="card-body no-padding">
                                ...
                                ?>
                                    ...
                                    <div class="page-block transition-block">
                                        ...
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="/images/pages/<?php echo $page["page_icon"] ?>" data-page-popover="<?php echo $page["page_no"] ?>" alt="">
                                        <div class="page-meta">
                                            <a href="/pages/main">
                                        ...
                                        <div class="add-page add-transition">
                                            <i data-page-id="<?php echo $page["page_id"]; ?>" data-feather="bookmark"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body no-padding">
                                ...
                                ?>
                                    <div class="page-block">
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="/images/profile-images/<?php echo $friendDetails["user_image"]; ?>" data-page-popover="<?php echo $friendDetails["user_no"]; ?>" alt="">
                                        <div class="page-meta">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="compose">
                                            <div class="compose-form">
                                                <img src="https://via.placeholder.com/300x300" data-demo-src="images/profile-images/<?php echo $_SESSION["image"]; ?>" alt="">
                                                <div class="control">
                                            ...
                                            <div class="columns is-multiline is-full">
                                                ...
                                                <div class="column is-6 is-narrower">
                                                    <div class="compose-option is-centered">
                                                        ...
                                                        <input id="feed-upload-input-1" form="post-compose-content" name="post-image" type="file" accept=".png, .jpg, .jpeg" onchange="readURL(this)">
                                                    </div>
                                                </div>
                                                <!-- Mood action -->
                                                <div class="column is-6 is-narrower">
                                        ...
                                        <div id="basic-options" class="compose-options">
                                            ...
                                            <div class="compose-option">
                                                <i data-feather="camera"></i>
                                                <span>Media</span>
                                                <input id="feed-upload-input-2" form="post-compose-content" name="post-image-2" type="file" accept=".png, .jpg, .jpeg" onchange="readURL(this)">
                                            </div>
                                            <!-- Mood action -->
                                            ...
                                            <div class="target-channels">
                                                ...
                                                <div class="channel">
                                                    <div class="round-checkbox is-small">
                                                        <div>
                                                            <input type="checkbox" name="activity-feed-activated" id="checkbox-1" checked>
                                                    ...
                                                    <!-- Dropdown menu -->
                                                    <div id="activity-dropdown" class="dropdown is-spaced is-modern is-right is-neutral dropdown-trigger">
                                                        <div>
                                                            <button class="button" aria-haspopup="true">
                                                                <i class="main-icon" id="activity-main-icon" data-feather="smile"></i>
                                                        ...
                                                        <div class="dropdown-menu" role="menu">
                                                            <div class="dropdown-content">
                                                                <a data-replacement-icon='<svg id="activity-main-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>' data-restriction-level="Public" class="dropdown-item activity-restriction">
                                                                    <div class="media">
                                                                ...
                                                                <a data-replacement-icon='<svg id="activity-main-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>' data-restriction-level="Friends" class="dropdown-item activity-restriction">
                                                                    <div class="media">
                                                                ...
                                                                <!--                                                            </a>-->
                                                                <hr class="dropdown-divider">
                                                                <a data-replacement-icon='<svg id="activity-main-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>' data-restriction-level="Only me" class="dropdown-item activity-restriction">
                                                                    <div class="media">
                                                ...
                                                <div class="channel">
                                                    <div class="round-checkbox is-small">
                                                        <div>
                                                            <input disabled type="checkbox" name="post-story-activated" id="checkbox-2">
                                                    ...
                                                    <div class="dropdown is-spaced is-modern is-right is-neutral dropdown-trigger">
                                                        <div>
                                                            <button class="button" aria-haspopup="true">
                                                                <i id="story-main-icon" class="main-icon" data-feather="smile"></i>
                                                        ...
                                                        <div class="dropdown-menu" role="menu">
                                                            <div class="dropdown-content">
                                                                <a data-replacement-story='<svg id="story-main-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>' data-restriction-level="Public" class="dropdown-item story-restriction">
                                                                    <div class="media">
                                                                        <i data-feather="globe"></i>
                                                                        <div class="media-content">
                                                                            <h3>Public</h3>
                                                                ...
                                                                <a data-replacement-story='<svg id="story-main-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>' data-restriction-level="Friends" class="dropdown-item story-restriction">
                                                                    <div class="media">
                                                                        <i data-feather="users"></i>
                                                                        <div class="media-content">
                                                                            <h3>Friends</h3>
                                                                ...
                                                                <a data-replacement-story='<svg id="story-main-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>' data-restriction-level="Friends-&-Contacts" class="dropdown-item story-restriction">
                                                                    <div class="media">
                                                                        <i data-feather="users"></i>
                                                                        <div class="media-content">
                                                ...
                                                <div class="list-body">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="friend-block">
                                                            <div class="round-checkbox is-small">
                                                                <div>
                                                                    <input type="checkbox" id="checkbox-<?php echo $index ?>">
                                                                    <label for="checkbox-<?php echo $index ?>"></label>
                                                                </div>
                                                            </div>
                                                            <img class="friend-avatar" src="https://via.placeholder.com/300x300" data-demo-src="/images/profile-images/<?php echo $friend[0]["user_image"] ?>" alt="">
                        ...
                        <div id="feed-post-1" class="card is-post">
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="card-heading">
                                    ...
                                    <div class="user-block">
                                        <div class="image">
                                            <img src="https://via.placeholder.com/300x300" data-demo-src="images/pages/logo.png" data-pages-popover="1" alt="">
                                        </div>
                                        <div class="user-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Featured image -->
                                    <div class="post-image">
                                        <a data-fancybox="post1" data-lightbox-type="comments" data-thumb="images/pages/logo.png" href="https://via.placeholder.com/1600x900" data-demo-href="images/pages/logo.png">

                                            <img src="https://via.placeholder.com/1600x900" data-demo-src="images/pages/logo.png" alt="">
                                        </a>
                                        <!-- Action buttons -->
                                    ...
                                    <div class="media is-comment">
                                        ...
                                        <div class="media-content">
                                            ...
                                            <div class="media is-comment">
                                                ...
                                                <div class="media-left">
                                                    <div class="image">
                                                        <img src="https://via.placeholder.com/300x300" data-demo-src="images/pages/logo.png" data-user-popover="1" alt="">
                                                    </div>
                                                </div>
                                                <!-- Content -->
                                                <div class="media-content">
                                ...
                                <div class="card-footer">
                                    <div class="media post-comment has-emojis">
                                        ...
                                        <div class="media-content">
                                            ...
                                            <div class="actions">
                                                <div class="image is-32x32">
                                                    <img class="is-rounded" src="https://via.placeholder.com/300x300" data-demo-src="images/pages/logo.png" data-user-popover="1" alt="">
                                                </div>
                                                <div class="toolbar">
                                                    <div class="action is-auto">
                                                        <i data-feather="at-sign"></i>
                                    ...
                                    <div class="story-block">
                                        <div class="img-wrapper">
                                            <a href="javascript:void(0);" class="add-story">
                                                <img id="<?php echo $storyOwner["user_id"]; ?>" src="https://via.placeholder.com/300x300" data-fancybox href="/images/media/posts/<?php echo $story["story_media"] ?>" data-demo-src="/images/profile-images/<?php echo $storyOwner["user_image"]; ?>" alt="User image">
                                            </a>
                                        </div>
                                        <div class="story-meta">
                                ...
                                ?>
                                    <div>
                                        <div class="birthday-avatar">
                                            <img src="https://via.placeholder.com/300x300" data-demo-src="/images/profile-images/<?php echo $friend["user_image"]; ?>" alt="User image">
                            ...
                            <div class="card-body no-padding">
                                ...
                                ?>
                                        ...
                                        <div class="add-friend-block transition-block">
                                            <img src="https://via.placeholder.com/300x300" data-demo-src="/images/profile-images/<?php echo $friendship["user_image"]; ?>" data-user-popover="<?php echo $friendship["user_no"]; ?>" alt="User image">
                                            <div class="page-meta">
                                                <span><?php echo $friendship["user_fullname"]; ?></span>
                                                <span><?php echo $friendship["user_country"]; ?></span>
                                            </div>
                                            <div data-user-id="<?php echo $friendship["user_id"]; ?>" class="add-friend add-transition">
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="job-avatar">
                                        <img src="https://via.placeholder.com/300x300" data-demo-src="/assets/img/logo/logo.png" alt="">
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="action">
                            <button type="button" class="button is-solid accent-button next-modal raised" data-modal="albums-modal">Next
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="action">
                            <button type="button" class="button is-solid accent-button next-modal raised" data-modal="videos-modal">Next
                            </button>
                        </div>
                    </div>
                </div>
