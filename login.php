                ...
                <div class="hero-body">
                    <div class="form-wrapper">
                        ...
                        <div class="avatar">
                            ...
                            <img src="https://placehold.it/128x128" data-demo-src="assets/img/avatars/avatar-w.png"
                                 alt="">
                        </div>
                        <form id="loginForm">
                            <div class="login-form">
                                ...
                                <div class="field">
                                    <div class="control">
                                        <input id="user_email" class="input email-input" name="user_email" type="text"
                                               placeholder="email@nerdlibary.com">
                                ...
                                <div class="field">
                                    <div class="control">
                                        <input class="input password-input" id="user_password" name="user_password"
                                               type="password"
                                               placeholder="●●●●●●●">
                                        <div class="input-icon">
                                ...
                                <div class="field">
                                    <div class="control">
                                        <button type="submit" name="user_login" id="loginBtn"
