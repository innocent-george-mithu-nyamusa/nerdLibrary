...
<body>
    ...
    <?php
    include "includes/frontEnd/main-navbar-v2.php";
    $allEpisodes = $episodeObj->allLikedSeriesEpisodes($series["series_id"], $_SESSION["user_id"]) ?? [];
    ?>
                    ...
                    <div class="home-wrapper">
                        ...
                        <div class="home-content">
                            <div class="collections-header">
                                <a class="is-active">Liked Episodes</a>
