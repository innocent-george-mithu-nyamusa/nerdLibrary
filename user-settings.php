            ...
            <div class="settings-sidebar-inner">
                <div class="user-block">
                    ...
                    <div class="avatar-wrap">
                        <img src="https://via.placeholder.com/150x150" data-demo-src="/images/profile-images/<?php echo $_SESSION["image"]; ?>" data-user-popover="89" alt="stuff about stuff">
                                ...
                                <div class="columns is-multiline">
                                    ...
                                    <div class="column is-6">
                                        ...
                                        <div class="field field-group">
                                            ...
                                            <div class="control has-icon">
                                                <input type="text" name="full-name" class="input is-fade" value="<?php echo $currentUser[0]["user_fullname"]; ?>" required>
                                                <div class="form-icon">
                                        ...
                                        <div class="field field-group">
                                            <label>Email</label>
                                            <div class="control has-icon">
                                                <input type="text" name="email" class="input is-fade" value="<?php echo $currentUser[0]["user_email"]; ?>" required>
                                                <div class="form-icon">
                                    ...
                                    <div class="column is-6">
                                        ...
                                        <div class="field field-group">
                                            ...
                                            <div class="control has-icon">
                                                <input type="text" name="username" class="input is-fade" value="<?php echo $currentUser[0]["username"]; ?>" required>
                                                <div class="form-icon">
                                                    <i data-feather="user"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="field field-group">
                                            ...
                                            <div class="control has-icon">
                                                <input type="text" name="backup-email" class="input is-fade" value="<?php echo $currentUser[0]["user_backup_email"]; ?>" required>
                                                <div class="form-icon">
                                                    <i data-feather="mail"></i>
                                                </div>
                                            </div>
                                    ...
                                    <div class="column is-12">
                                        ...
                                        <div class="field field-group">
                                            <label>Address</label>
                                            <div class="control">
                                                <textarea type="text" name="address" class="textarea is-fade" rows="1" placeholder="Fill in your address..." required>
                                                <?php
                                    ...
                                    <div class="column is-6">
                                        ...
                                        <div class="field field-group">
                                            <label>City</label>
                                            <div class="control has-icon">
                                                <input type="text" name="city" class="input is-fade" value="<?php echo $currentUser[0]["user_town"]; ?>" required>
                                                <div class="form-icon">
                                    ...
                                    <div class="column is-6">
                                        ...
                                        <div class="field field-group is-autocomplete">
                                            <label>Country</label>
                                            <div class="control has-icon">
                                                <input id="country-autocpl" name="country" type="text" class="input is-fade" value="<?php echo $currentUser[0]["user_country"]; ?>" required>
                                                <div class="form-icon">
                                    ...
                                    <div class="column is-12">
                                        <div class="buttons">
                                            <button type="submit" id="save-general-settings" class="button is-solid accent-button form-button">Save Changes
                                            </button>
                                            <a id="advanced-option-button" data-section="advanced" class="button is-light form-button">Advanced</a>
                                        </div>
                                    </div>
                                ...
                                <div class="columns is-multiline">
                                    ...
                                    <div class="column is-6">
                                        ...
                                        <div class="field field-group">
                                            ...
                                            <div class="control has-icon">
                                                <input type="text" name="phone" class="input is-fade" value="<?php echo $currentUser[0]["user_phone"]; ?>">
                                                <div class="form-icon">
                                                    <i data-feather="user"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="field field-group">
                                            ...
                                            <div class="control has-icon">
                                                <input type="text" name="linkedIn" class="input is-fade" value="<?php echo $currentUser[0]["user_linkedIn"]; ?>">
                                                <div class="form-icon">
                                                    <i data-feather="mail"></i>
                                                </div>
                                            </div>
                                    ...
                                    <div class="column is-6">
                                        ...
                                        <div class="field field-group">
                                            ...
                                            <div class="control has-icon">
                                                <input type="date" name="dob" class="input is-fade" value="<?php echo $currentUser[0]["user_dob"]; ?>">
                                                <div class="form-icon">
                                                    <i data-feather="user"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="field field-group">
                                            ...
                                            <div class="control has-icon">
                                                <input type="text" name="facebook" class="input is-fade" value="<?php echo $currentUser[0]["user_facebook"]; ?>">
                                                <div class="form-icon">
                                                    <i data-feather="mail"></i>
                                                </div>
                                            </div>
                                    ...
                                    <div class="column is-12">
                                        ...
                                        <div class="field field-group">
                                            ...
                                            <div class="control">
                                                <textarea type="text" name="bio" class="textarea is-fade" rows="1" placeholder="">
                                                <?php
                                    ...
                                    <div class="column is-6">
                                        ...
                                        <div class="field field-group">
                                            <label>Status</label>
                                            <div class="control has-icon">
                                                <input type="text" name="user-floor" class="input is-fade" value="<?php echo $currentUser[0]["user_status"] ? "verified" : "not verified"; ?>" readonly>
                                                <div class="form-icon">
                                                    <i data-feather="map-pin"></i>
                                                </div>
                                            </div>
                                    ...
                                    <div class="column is-6">
                                        ...
                                        <div class="field field-group is-autocomplete">
                                            ...
                                            <div class="control has-icon">
                                                <input type="text" name="user-building" class="input is-fade" value="<?php echo $currentUser[0]["user_role"] ? "Student" : "Lecturer" ?>" readonly>
                                                <div class="form-icon">
                                                    <i data-feather="globe"></i>
                                                </div>
                                            </div>
