...
function getPagesPopovers() {
    $("*[data-page-popover]").each((function () {
        var a = $(this), e = $(this).attr("data-page-popover"), n = feather.icons.mail.toSvg(),
            ...
            s = (feather.icons["map-pin"].toSvg(), feather.icons.users.toSvg()), i = feather.icons.tag.toSvg(),
            t = feather.icons.bookmark.toSvg();
        $.ajax({
            url: "assets/data/api/pages/pages.json", async: !0, dataType: "json", success: function (r) {
                a.webuiPopover({
                    trigger: "hover",
                    placement: "auto",
                    width: 300,
