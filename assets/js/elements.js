    ...
    if ($("#elements-page").length) {
        var t = function (t) {
            if (0 == (t = "string" == typeof t ? t : $(this).attr("href")).indexOf("#")) {
                var n = $(t);
                if (n.length && ($("html, body").animate({scrollTop: n.offset().top - 50 - 20}), history && "pushState" in history)) return history.pushState({}, document.title, window.location.pathname + t), !1
            }
        }, n = function () {
            ...
            $("#albums-help-modal .next-modal").on("click", (function () {
                var t = $(this), e = t.attr("data-modal");
            ...
            $("#videos-help-modal .next-modal").on("click", (function () {
                var t = $(this), n = $(this).attr("data-modal");
        ...
        t(window.location.hash), $("body").on("click", ".submenu-wrap a", t), $(".element-menu .menu-trigger").on("click", (function () {
            ...
            $('[data-fancybox="cl-group-demo"]').fancybox({
                ...
                t = $.extend(!0, {
                    ...
                    opts: {
                        ...
                        afterClose: function (n, e, o) {
                            var i = o ? o.target || o.currentTarget : null, a = i ? $(i).data("value") : 0;
                            t.callback(a)
                        }
                    }
                })
                ...
                $.fancyConfirm({
                    ...
                    message: "You are about to delete a post permanently. UserPost content and attachements will be lost without being ablt to be recovered",
                    okButton: "Delete",
                    noButton: "Cancel",
                    callback: function (t) {
                ...
                return n.prototype.init = function (t) {
                    ...
                    var t = this.$clone, n = this.getScale(), e = this.$btn, o = e.offset();
                    t.css({
                    ...
                    var t = this.$btn, n = .5 * t.outerWidth(), e = t.offset().left + n - $(window).scrollLeft(),
                        o = t.offset().top + n - $(window).scrollTop(), i = $(window).width(), a = $(window).height(),
                        s = e > i / 2 ? e : i - e, c = o > a / 2 ? o : a - o;
                    return Math.ceil(Math.sqrt(Math.pow(s, 2) + Math.pow(c, 2)) / n)
                }, n.prototype.complete = function () {
                    var t = this.$btn;
                    $.fancybox.open({src: t.data("src") || t.attr("href")}, this.opts)
                }, n.prototype.close = function () {
                    var t = this, n = t.$clone;
