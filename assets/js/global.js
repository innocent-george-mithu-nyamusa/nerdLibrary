...
var postFormData = new FormData(), allId = [], user = {"user": null, "id": null};
...
function initLikeButton() {
    $(".like-button").on("click", (function () {
        ...
        var itemOwner = $(this).data("item-owner");
        var isFavorite = "true";
        ...
        var t = "", o = "", i = {
            ...
            list: {
                maxNumberOfElements: 5, showAnimation: {
                    ...
                    allId.push({
                        id: $("#users-autocpl").getSelectedItemData().id,
                        name: $("#users-autocpl").getSelectedItemData().name
                    })
...
function initPreviewLink(item) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#post-link-id-" + postId).replaceWith(linkHtml);
