...
$allEpisodes = $episodeObj->allSeriesEpisodes($series["series_id"]);
        ...
        <div class="sub-nav">
            <div class="sub-nav-tabs">
                <div class="tabs is-centered">
                    <ul>
                        <li class="is-active">
                            <a href="navbar-v2-feed.html">Course Overview </a>
                        </li>
                        <li>
                            <a href="navbar-v2-profile-friends.html">All Episodes</a>
                        </li>
                        <li>
                            <a href="navbar-v2-groups.html">Discover Series</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="home-wrapper">
                        ...
                        <div class="home-content">
                            <div class="collections-header">
                                <a href="/course-library/latest/<?php echo $series["series_id"]; ?>" class="is-active">All Chapters</a>
                                <a>Viewed</a>
                                <a>Incomplete</a>
