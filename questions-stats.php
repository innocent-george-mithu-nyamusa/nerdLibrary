...
<head>
    ...
    <title> Statistics | NerdLibrary</title>
            ...
            <div class="inner is-scrollable">
                <div class="container">
                    <div class="questions-nav-menu">
                        <a href="/questions/home" class="menu-item">
                        ...
                        <a href="/stats" class="menu-item is-active">
                        ...
                        <a href="/questions/settings" class="menu-item">
            ...
            <div class="container">
                ...
                <div id="questions-shadow-dom-stats" class="columns">
                    ...
                    <div class="column is-3">
                        ...
                        </div> <!-- /html/partials/global/placeload/placeloads/questions-side-placeload.html -->
                        <div class="placeload questions-side-placeload">
                            <div class="inner-wrap">
                                <div class="img loads"></div>
                                <div class="content-shape loads"></div>
                ...
                <div class="columns true-dom is-hidden">
                        ...
                        <div class="stats-wrapper">
                            <div class="stats-header">
                                <div class="avatar-wrapper">
                                    <img class="avatar" src="https://via.placeholder.com/150x150" data-demo-src="/images/profile-images/<?php echo $user[0]["user_image"]; ?>" data-user-popover="<?php echo $user[0]["user_no"]; ?>" alt="User profile Image">
                                    <div class="badge">
                                        <i data-feather="check"></i>
                                    </div>
                                </div>
                                <div class="user-info">
                                    <h4><?php echo $user[0]["user_fullname"]; ?></h4>
                                    <p>From <?php echo $user[0]["user_town"]; ?></p>
                                ...
                                <div class="activity-list">
                                    <div class="activity-item is-best">
                                        ...
                                        <div class="meta">
                                            ...
                                            <span>Just asked <a>Is there a way to quickly convert a project from Angular to React?</a></span>
                                    ...
                                    <div class="activity-item">
                                        ...
                                        <div class="meta">
                                            ...
                                            <span>Marked <a>your answer</a> as the best answer to his question.</span>
                                    ...
                                    <div class="activity-item">
                                        ...
                                        <div class="meta">
                                            ...
                                            <span>Replied to <a>Is there a cheatsheet listing all available browser polyfills?</a></span>
                                    ...
                                    <div class="activity-item is-best">
                                        ...
                                        <div class="meta">
                                            ...
                                            <span>Marked <a>your answer</a> as the best answer to her question.</span>
                    ...
                    <div class="column is-3">
                        <div class="questions-side-card">
                            ...
                            <h4>Help center</h4>
                            <p>Having trouble? Please search our <a class="standard-link">Help Center</a> for a quick answer to your problem.
                            </p>
                        </div>
                        ...
                        <div class="questions-side-card">
                            ...
                            <h4>24/7 Support</h4>
                            <p>Our Help Center didn't help? Please contact our 24/7 <a class="standard-link">Customer Assistance</a> hotline.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="explorer-inner">
            <div class="explorer-container">
                ...
                <div class="explore-list has-slimscroll">
                    <!--item-->
                    <a href="main-user-feed.php" class="explore-item">
                        <img src="assets/img/icons/explore/clover.svg" alt="">
                        <h4>Feed</h4>
                    </a>
                    <!--item-->
                    <a href="user-profile-friends.php" class="explore-item">
                        <img src="assets/img/icons/explore/friends.svg" alt="">
                        <h4>Friends</h4>
                    </a>
                    <!--item-->
                    <a href="course-track.php" class="explore-item">
                    ...
                    <!--item-->
                    <a href="shop.php" class="explore-item">
                        <img src="assets/img/icons/explore/cart.svg" alt="">
                        <h4>Commerce</h4>
                    </a>
                    <!--item-->
                    <a href="explore.php" class="explore-item">
                    ...
                    <!--item-->
                    <a href="elements.php" class="explore-item">
