...
<head>
    ...
    <title> Explore Category Courses | NerdLibrary </title>
...
$allSeries = $seriesObj->getInterestCategorySeries($_GET["cId"]);
?>
                ...
                foreach ($allSeries as $series) {
                    ...
                    <div class="column is-3">
                        <article class="group-box">
                            ...
                            <div class="box-img has-background-image"
                                 data-background="https://via.placeholder.com/940x650"
                                 data-demo-background="/images/series/<?php echo $series['series_image']; ?>"></div>
                            <a href="/course-track/<?php echo $series["series_id"]; ?>" class="box-link">
                                <div class="box-img--hover has-background-image"
                                     data-background="https://via.placeholder.com/940x650"
                                     data-demo-background="/images/series/<?php echo $series['series_image']; ?>"></div>
                            </a>
                            <div class="box-info">
                                ...
                                <span class="box-members">
                                        ...
                                        <div class="members-preview">
                                            <img src="https://via.placeholder.com/150x150"
                                                 ...
                                                 data-user-popover="<?php echo $lecturer['user_no']; ?>" alt="">
                                        </div>
                                </span>
                            </div>
                        </article>
