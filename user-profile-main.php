...
<!--                    HIGHLIGHT:: PLACE EXTERNAL URL BASED IMAGES WHEN HOSTING IMAGES-->
                    <div class="is-photos-widget">
                        ...
                        <img src="https://via.placeholder.com/200x200"
                             data-demo-src="/images/media/posts/<?php echo $photo["photo_name"]; ?>" alt="User Images">
                        <?php } ?>
                    </div>
                    <!-- Star friends widget -->
                            ...
                            foreach ($allFriendships as $friendShip) {
                                ...
                                <div class="friend-item">
                                    <img src="https://via.placeholder.com/300x300"
                                         ...
                                         alt="" data-user-popover="<?php echo $friendDetails["user_no"]; ?>">
                    ...
                    <div class="is-videos-widget">
                        ...
                        <?php foreach ($allVideos as $video) { ?>
                            ...
                            <div class="video-container">
                                <img src="https://via.placeholder.com/200x200"
                                     data-demo-src="/images/media/thumbnails/<?php echo $video["video_thumbnail"]; ?>"
                                     alt="Video Thumbnail">
                    ...
                    <div class="trip-cards-list">
                        <div class="card is-trip-card">
                            <?php foreach ($allBadges as $badge) { ?>
                                ...
                                <div class="trip-item">
                                    <img src="https://via.placeholder.com/200x200"
                                         data-demo-src="/images/media/badges/<?php echo $badge["badge_image"] ?>"
                                         alt="">
                                    <div class="text-content">
                        ...
                        <div class="schedule-calendar">
                            ...
                            <div class="calendar-row">
                                ...
                                <div class="day event green" data-content="1" data-day="2"
                                     data-event="Eat at mom and dad's">2
                                </div>
                                <div class="day">3</div>
                                <div class="day">4</div>
                                <div class="day">5</div>
                            ...
                            <div class="calendar-row">
                                ...
                                <div class="day event purple" data-content="2" data-day="7"
                                     data-event="Meet customer in LA">7
                                </div>
                                <div class="day">8</div>
                                <div class="day">9</div>
...
<!--                             Timeline -->
                            <div class="time is-hidden-mobile">
                                <div class="img-container">
                                    <img src="https://via.placeholder.com/300x300"
                                         data-demo-src="/images/profile-images/<?php echo $postOwner["user_image"]; ?>" alt="User image">
                                </div>
                            </div>
...
<!--                                         Post body text -->
                                        ...
                                        <?php if (isset($feedPost["post_shared_link"]) && ($feedPost["post_type"] == "photo")) { ?>
                                            ...
                                            <div class="post-image">
                                                <a data-fancybox="<?php echo $feedPost["post_id"] ?>" data-lightbox-type="comments"
                                                   ...
                                                   data-demo-href="/images/media/posts/<?php echo $feedPost["post_images"] ?>">
                                                    <img src="https://via.placeholder.com/1600x900"
                                                         data-demo-src="/images/media/posts/<?php echo $feedPost["post_images"] ?>" alt="">
                                                </a>
