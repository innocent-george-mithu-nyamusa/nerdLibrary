...
<head>
    ...
    <title> Single Question | NerdLibrary </title>
                    ...
                    <div id="questions-shadow-dom-single" class="columns">
                        <div class="column">
                            ...
                            <div class="top-single-header has-text-right">
                                <a href="/questions/home" class="button is-solid grey-button is-rounded">Back To Questions</a>
                            </div>
                        ...
                        <div class="column">
                            ...
                            <div class="question-content">
                                ...
                                <div class="question-block">
                                    <!-- Title -->
                                    <h2 class="question-title">How can I handle photos with javascript?</h2>
                                    <!-- Author -->
                                    ...
                                    <div class="question-text">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. At eum nihili facit; Quacumque
                                            enim ingredimur, in aliqua
                                            historia vestigium ponimus. Duo Reges: constructio interrete. Proclivi currit oratio.
                                            Quae contraria sunt his, malane? Quod quidem nobis non saepe contingit. Hoc loco tenere
                                            se Triarius non potuit.</p>
                                    </div>
                                    <!-- Footer -->
                                ...
                                <div class="answer-block is-best">
                                    ...
                                    <div class="answer-author">
                                        ...
                                        <div class="meta">
                                            <span>Elise Walker <small class="best-tag">Best Answer</small></span>
                                            <span>1 day ago</span>
                                        </div>
                                    </div>
                                    <!-- Content -->
                                    <div class="answer-text">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. At eum nihili facit; Quacumque
                                            enim ingredimur, in
                                            aliqua historia vestigium ponimus. Duo Reges: constructio interrete. Proclivi currit
                                            oratio.</p>
                                        <p>First install this:</p>
                                        <p class="code">
                                            npm install photo_module_js - - save
                                        </p>
                                        <p>Then configure your photos:</p>
                                        <p class="code">
                                            $var product = this.getProduct.productDetails;
                                            <br>$var photoUrl = product.mainInmage.photoUrl;
                                            <br>for (var i = 0; i &lt; photoUrl.length; i++) { //do your stuff here }
                                        </p>
                                        <p>You can
                                            also check the documentation:</p>
                                        <p><a class="standard-link">https://friendkit/guides/ecommerce/products/docs</a></p>
                                    </div>
                                    <!-- Footer -->
                                ...
                                <div class="answer-block">
                                    ...
                                    <div class="answer-text">
                                        ...
                                        <p>Check this link:</p>
                                        <p><a class="standard-link">https://friendkit/questions/1856456</a></p>
                                    </div>
                                    <!-- Footer -->
                                    <div class="answer-footer">
                                        <div class="upvote">
