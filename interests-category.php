...
<head>
    ...
    <title> Interests Category | NerdLibrary </title>
...
$unsortedCategories = $categoryObj->getCategories();
    ...
    <div class="inner is-scrollable">
        <div class="container">
            <div class="questions-nav-menu">
                <a data-url="/" class="menu-item enter-app">
                    <i data-feather="home"></i>
                    <span>Home</span>
                </a>
                <a data-url="/explore" class="menu-item enter-app">
                    <i data-feather="message-circle"></i>
                    <span>Explore Courses</span>
                </a>
                <a data-url="nerdLibrary/profile/overview" class="menu-item enter-app">
                ...
                <a data-url="/profile/settings" class="menu-item enter-app">
                        ...
                        for ($i = 1; $i <= $numberOfSubdivisions; $i++) {
                            ...
                            if (floor($i % 2) != 0) {
                                ...
                                <div class="tile is-ancestor categories-tile-grid">
                                    <div class="tile is-vertical is-8">
                                        <div class="tile">
                                            <div class="tile is-parent is-vertical">
                                                ...
                                                <a data-category-id="<?php echo $smallCategories[0]["category_id"]; ?>" data-category-name="<?php echo $smallCategories[0]["category_name"] ?>" class="tile is-child category-box is-primary select-category">
                                                    <img class="light-image"
                                                         src="assets/img/illustrations/questions/<?php echo $smallCategories[0]["cat_icon"] ?>"
                                                         alt="">
                                                ...
                                                <a data-category-id="<?php echo $smallCategories[1]["category_id"]; ?>" data-category-name="<?php echo $smallCategories[1]["category_name"] ?>" class="tile is-child category-box is-accent select-category">
                                                    <img src="assets/img/illustrations/questions/<?php echo $smallCategories[1]["cat_icon"] ?>"
                                                         alt="">
                                                    <div class="box-content">
                                            ...
                                            <div class="tile is-parent is-vertical">
                                                ...
                                                <a data-category-id="<?php echo $smallCategories[2]["category_id"]; ?>" data-category-name="<?php echo $smallCategories[2]["category_name"] ?>" class="tile is-child category-box is-accent select-category">
                                                    <img src="assets/img/illustrations/questions/<?php echo $smallCategories[2]["cat_icon"] ?>"
                                                         alt="">
                                                    <div class="box-content">
                                                ...
                                                <a data-category-id="<?php echo $smallCategories[3]["category_id"]; ?>" data-category-name="<?php echo $smallCategories[3]["category_name"] ?>" class="tile is-child category-box is-primary select-category">
                                                    <img src="assets/img/illustrations/questions/<?php echo $smallCategories[3]["cat_icon"] ?>"
                                                         alt="">
                                                    <div class="box-content">
                                        ...
                                        <div class="tile is-parent">
                                            <a data-category-id="<?php echo $tallCategories[2]["category_id"]; ?>" data-category-name="<?php echo $tallCategories[2]["category_name"] ?>" class="tile is-child category-box is-accent is-row select-category">
                                                <img src="assets/img/illustrations/questions/<?php echo $tallCategories[2]["cat_icon"] ?>"
                                                     alt="">
                                                <div class="box-content">
                                    ...
                                    <div  class="tile is-parent is-vertical">
                                        <a data-category-id="<?php echo $tallCategories[0]["category_id"]; ?>" data-category-name="<?php echo $tallCategories[0]["category_name"] ?>" class="tile is-child category-box is-accent is-taller select-category">
                                            <img src="assets/img/illustrations/questions/<?php echo $tallCategories[0]["cat_icon"]; ?>"
                                                 alt="">
                                            <div class="box-content">
                                        ...
                                        <a data-category-id="<?php echo $tallCategories[1]["category_id"]; ?>" data-category-name="<?php echo $tallCategories[1]["category_name"] ?>" class="tile is-child category-box is-primary is-taller select-category">
                                            <img src="assets/img/illustrations/questions/<?php echo $tallCategories[1]["cat_icon"]; ?>"
                                                 alt="">
                                            <div class="box-content">
                                ...
                                <div class="tile is-ancestor">
                                    <div class="tile is-parent is-vertical">
                                        <a class="tile is-child category-box is-accent is-taller">
                                            <img class="light-image" src="assets/img/illustrations/questions/<?php echo $tallCategories[0]["cat_icon"]; ?>"
                                                 alt="">
                                            <img class="dark-image" src="assets/img/illustrations/questions/<?php echo $tallCategories[0]["cat_icon"]; ?>"
                                                 alt="">
                                            <div class="box-content">
                                                <h3 class="title is-6"><?php echo $tallCategories[0]["category_name"]; ?></h3>
                                                <p><?php echo $tallCategories[0]["cat_description"]; ?></p>
